...
const perks = [
    ...
    },
    {
        ...
        icon: CheckCircle,
        description: "Every asset is verified by our team.",
    },
    {
        name: "For the Planet",
        icon: Leaf,
        description: "We've pledged 1% of our profits to environmental causes.",
    },
];
            ...
            <MaxWidthWrapper>
                <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
                    <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl ">
                        Your marketplace for high-quality <span className="text-orange-600">digital assets</span>.
                    </h1>
